...
- `assets/publications.json`: bibliography
...
to update the publication list and recent work together.
...
Scopus profile links are retained without displaying citation metrics.
